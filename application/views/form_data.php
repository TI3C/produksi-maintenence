...
<head>
    ...
    <title>Form Maintenance | Korporasi</title>
		...
		<div class="row col-md-4">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<div class="panel-title" align="center" style="font-size:30px">Form Maintenance</div>
					</div>
...
<div class="table-responsive">
	...
	<form action="" method="POST">
		...
		<div class="form-group">
			<p> Kd_Maintenance :<input type="text" name="Kd_Maintenance" placeholder="Kd_Maintenance" class="form-control"/></p>
		</div>

		<div class="form-group">
			<p> Tanggal Perbaikan :<input type="date" name="Tgl_Perbaikan" id="tanggal" placeholder="Tgl_Perbaikan" class="form-control"/></p>
		</div>
