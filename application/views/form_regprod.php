...
<head>
    ...
    <title>Form Registrasi Produk | Koorporasi</title>
		...
		<div class="row col-md-6">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<div class="panel-title" align="center" style="font-size:30px">Form Registrasi Produk</div>
					</div>
...
?>
	...
	<table>
		...
		<tr>
			...
			<td>
			<select name='Kualitas' <?php echo form_dropdown('pilihan', $pilihan);?>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
			<input type="text" name="Tgl_Registrasi" value=<?php echo $tgl?> class="form-control"/>
			</td>
		</tr>
	</table>
