...
<head>
    ...
    <title>Form Edit Jenis Produk | Korporasi</title>
		...
		<div class="row col-md-6">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<div class="panel-title" align="center" style="font-size:30px">Form Edit Jenis Produk</div>
					</div>
...
<!-- <td align="center"><h1>Form Edit Registrasi Produk</h1></td> -->
	...
	<tr>
		...
		<tr>
			...
			<td>
			<input type="text" name="Foto" class="form-control" value="<?php echo $data['Foto']?>" disabled="disabled"/>
			</td>
		</tr>
		<tr>
			<td>
